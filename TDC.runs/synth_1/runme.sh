...
HD_PWD='D:/WISNU/FPGA/TDC/TDC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log delay_line_tdc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source delay_line_tdc.tcl
